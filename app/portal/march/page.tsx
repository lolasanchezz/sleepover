    ...
    <div className="min-h-screen" style={{ backgroundColor: "#C0DEFE" }}>
      ...
      >
        <div className="text-center">
          <h1 className="text-[48px] md:text-[72px] leading-[60px] md:leading-[90px] mb-16">
            <GradientText
            ...
            >
              ...
              <article className="max-w-4xl text-left mt-8 text-[20px] md:text-[22px] pr-8 md:pr-16" style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontSize: '1.25rem', lineHeight: '1.7' }}>
